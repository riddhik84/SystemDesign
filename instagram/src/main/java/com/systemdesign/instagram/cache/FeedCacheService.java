 ...
 *
 * Key namespace:
 *   insta:feed:{userId}   → ZSET (member=postId, score=createdAt epoch millis)
 *
...
public class FeedCacheService {
    ...
    private static final String FEED_PREFIX = "insta:feed:";
    ...
    public FeedCacheService(StringRedisTemplate redis, ObjectMapper objectMapper) {
        this.redis = redis;
    ...
    public void addToFeed(String userId, String postId, long scoreMs) {
        try {
            ...
            // ZREMRANGEBYRANK removes elements with rank [0, -(maxCachedFeed+1)]
